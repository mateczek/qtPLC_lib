...
*/
 char * DECL2 daveStrerror(int code); // result is char because this is usual for strings
...
*/
 void DECL2 daveStringCopy(char * intString, char * extString); // args are char because this is usual for strings
...
/*
 daveConnection * DECL2 daveNewEonnection(daveInterface * di,
	    void * Destination, 
	    int DestinationIsIP, 
	    int rack, int slot, 
	    int routing, 
...
// void DECL2 _daveDump(char * name, uc *b, int len);
 void DECL2 _daveDump(char * name, void *b, int len);

/*
    names for PLC objects:
*/
 char * DECL2 daveBlockName(uc bn);  // char or uc,to decide
 char * DECL2 daveAreaName(uc n); // to decide
...
*/
 ...
 float DECL2 daveGetKGfrom(uc *b);
/*
...
*/
 ...
 uc * DECL2 davePutKG(uc *b,float v);
 ...
 void DECL2 davePutKGAt(uc *b,int pos, float v);
/**
...
*/
 void DECL2 _daveConstructUpload(PDU *p, char blockType, int blockNr); // char or uc,to decide
...
#define daveOrderCodeSize 21
 int DECL2 daveGetOrderCode(daveConnection * dc, char * buf); // char, users buffer, or to decide
...
*/
 int DECL2 daveWriteManyBytes(daveConnection * dc,int area, int DB, int start, int len, void * buffer);
/* 
    Bit manipulation:
*/
...
*/
 ...
 int DECL2 daveReadSZL(daveConnection * dc, int ID, int index, void * buf, int buflen);
...
*/
 int DECL2 initUpload(daveConnection * dc, char blockType, int blockNr, int * uploadID); // char or uc,to decide
...
/* Adds a new variable to a prepared request: */
 void DECL2 daveAddVarToReadRequest(PDU *p, int area, int DBnum, int start, int bytes);
...
/* Adds a new variable to a prepared request: */
 void DECL2 daveAddVarToWriteRequest(PDU *p, int area, int DBnum, int start, int bytes, void * buffer);
...
#define davePartnerListSize 126
 ...
 int DECL2 _daveInitAdapterMPI2(daveInterface * di);
 ...
 int DECL2 _daveExchangeMPI(daveConnection * dc,PDU * p1);
 ...
 int DECL2 _daveExchangeMPI3(daveConnection * dc,PDU * p1);
 int DECL2 _daveIncMessageNumber(daveConnection * dc);

/* ISO over TCP specific functions */
 int DECL2 _daveExchangeTCP(daveConnection * dc,PDU * p1);
...
*/
 ...
 int DECL2 _daveReadChars(daveInterface * di,	uc *b, tmotype tmo, int max);
 int DECL2 _daveReadChars2(daveInterface * di,uc *b, int max);
...
*/
 ...
 void DECL2 _daveSendSingle(daveInterface * di, uc c);
 ...
 int DECL2 _daveSendWithCRC(daveInterface * di, uc *b, int size);
...
*/
 ...
 int DECL2 _daveWriteIBH(daveInterface * di, uc * buffer, int len);
...
**/
 ...
 int DECL2 daveGetErrorOfResult(daveResultSet *,int number);
...
*/
 ...
 int DECL2 _daveSendMessageAS511(daveConnection * dc, PDU * p);
 ...
 int DECL2 _daveReadS5ImageAddress(daveConnection * dc, uc area, daveS5AreaInfo * ai);
 int DECL2 _daveIsS5ImageArea(uc area);
 int DECL2 _daveIsS5DBBlockArea(uc area);
...
typedef struct {
 ...
 int DECL2 _daveCP_send(int fd, int len, uc * reqBlock);
 ...
 int DECL2 _daveInitAdapterNLpro(daveInterface * di);
 int DECL2 _daveInitStepNLpro(daveInterface * iface, int nr, uc* fix, int len, char*caller, uc * buffer);
